...
function getselectedItem(){
	if (get_cookie(m_location) != ""){
		selectedItem=get_cookie(m_location)
		return selectedItem
	}
	else
		return ""
...
function saveswitchstate(){
	...
	document.cookie= m_location+"="+selectedItem

}

function do_onload(){
	getElementbyClass("nodisplay")
